...
export default function HomePage(props) {
	...
	return (
	 <div id="root" style={{position:"relative", width:"100vw", minHeight:"100vh", backgroundColor:"yellow"}}>
	 	<h1>VISUALIZE COMPUTER SCIENCE</h1>
	 	<form onSubmit={handleSubmit}>
	 	Rows<input type="number"/><br/>
	 	Cols<input type="number"/><br/>
      	<button type="submit">CREATE
      	</button>
	 	</form>
	 	{msg}
	 	<Grid srcfocused={srcfocused} setsrcfocus={setsrcfocus} rows={rows} cols={cols}/>

	 	<br/>
	 	<br/>
	 	DJIKSTRA TRAVERSAL<br/>
	 	<button onClick={e=>setsrcfocus(true)}>SELECT SOURCE</button>	
	 		<button type="submit" onClick={djik_traverse}>Traverse</button>
